...
class AddEpisodeActivity : AppCompatActivity() {
    ...
    private fun save(showId: String) {
        if(viewModel.fileUri != null){
            ...
            viewModel.postEpisode(EpisodePost(showId, "", viewModel.titleInput, viewModel.descriptionInput, viewModel.seasonDefault.toString(),viewModel.episodeDefault.toString()))
            postEpisode()
        }
    }
